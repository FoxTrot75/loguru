...
#undef MAX
    ...
    enum NamedVerbosity : Verbosity
    {
        ...
        Verbosity_4       = +4,
        Verbosity_5       = +5,
        Verbosity_6       = +6, Verbosity_VERBOSE   = +6,   Verbosity_verbose   = +6,
        Verbosity_7       = +7, Verbosity_TRACE     = +7,   Verbosity_trace     = +7,
        Verbosity_8       = +8, Verbosity_DEBUG     = +8,   Verbosity_debug     = +8,
        Verbosity_9       = +9,
